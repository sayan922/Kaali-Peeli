...
import { Eye, EyeOff, Users, MapPin, Shield, ArrowRight } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { CaptainDataContext } from '../context/CapatainContext';
import axios from 'axios';
import LoginImage from '../utils/captainlogin.jpg';
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          >
            <div className="text-center">
              <h2 className="text-xl font-semibold text-gray-800">Captain Login</h2>
              <p className="text-sm text-gray-600">Sign in to your captain dashboard</p>
            </div>
            ...
            <p className="text-sm text-center text-gray-600">
              New to Kaali Peeli?{' '}
              <button onClick={() => navigate('/captain-signup')} className="font-semibold text-blue-600 hover:text-orange-700">
